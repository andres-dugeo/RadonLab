...
pl1[1].imshow(s_pruned.matrix_1.transpose(), interpolation="nearest", cmap=cm.get_cmap("seismic"), vmax=100000, vmin=-100000, aspect='auto')
...
pl1[2].imshow(s.matrix_1.transpose(), interpolation="nearest", cmap=cm.get_cmap("seismic"), vmax=100000, vmin=-100000, aspect='auto')
